...
\begin{figure}[ht]
    ...
    \caption{Modified drop-weight impact apparatus designed and commissioned
             at \acrshort{GSV}. (a) Overall view of the apparatus and its
             frame. (b) Close-up of the load-transfer assembly (bearing
             plate, \SI{5}{\tonne} load cell, striker plate) and the digital
             peak-force display.}
